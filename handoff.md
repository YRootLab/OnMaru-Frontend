...
- 소리마루 “장면을 따라 걷는 소리” 레일은 Core UI `fix/sorimaru-editorial-image-seams` 브랜치의 `bbf0ff8`를 가리키며, 인라인 이미지의 하단 베이스라인 여백·카드 외곽 그림자·다크 모드 테두리·하단 패널의 이중 클리핑과 반투명 모서리 프린지를 제거했다.
