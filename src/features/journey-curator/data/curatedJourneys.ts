...
export const JOURNEY_PLANS: Record<string, BentoJourneyPlan> = {
  quiet: {
    ...
    nodes: [
      ...
      { id: 'n-odii', label: '백인제가옥 해설', category: 'odii', x: 74, y: 22, badge: '소리마루' },
    ...
    edges: [
      ...
      { id: 'e3', source: 'n-hanok', target: 'n-odii', label: '공간 오디오 스토리' },
  ...
  market: {
    ...
    nodes: [
      ...
      { id: 'n-odii', label: '경기전 어진 이야기', category: 'odii', x: 74, y: 22, badge: '소리마루' },
    ...
    edges: [
      ...
      { id: 'e3', source: 'n-hanok', target: 'n-odii', label: '문화재 오디오 도슨트' },
  ...
  story: {
    ...
    moodKeywords: ['선비 문화', '역사 고증', 'ODII 해설', '만대루 절경'],
    nodes: [
      ...
      { id: 'n-odii', label: '병산서원 만대루', category: 'odii', x: 74, y: 22, badge: '소리마루' },
    ...
    edges: [
      ...
      { id: 'e3', source: 'n-hanok', target: 'n-odii', label: '서애 류성룡 스토리' },
  ...
  rainy: {
    ...
    nodes: [
      ...
      { id: 'n-odii', label: '소쇄처사 양산보 이야기', category: 'odii', x: 74, y: 22, badge: '소리마루' },
    ...
    edges: [
      ...
      { id: 'e3', source: 'n-hanok', target: 'n-odii', label: '가사문학 오디오' },
  ...
  rest: {
    ...
    nodes: [
      ...
      { id: 'n-odii', label: '월정교와 원효대사 설화', category: 'odii', x: 74, y: 22, badge: '소리마루' },
    ...
    edges: [
      ...
      { id: 'e3', source: 'n-hanok', target: 'n-odii', label: '월정교 설화 연결' },
