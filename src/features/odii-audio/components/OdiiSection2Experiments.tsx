  ...
  return (
    <section aria-labelledby="section-2-experiments-heading" className="mx-auto w-full max-w-[1080px] px-4 pb-10 pt-8 sm:px-8 sm:pb-14 sm:pt-12">
      <div className="mb-6 flex items-end justify-between gap-4 sm:mb-8">
        ...
        <span className="hidden shrink-0 rounded-full border border-[#211e19]/10 bg-white/60 px-3 py-1.5 text-[10px] text-[#8c7e6c] sm:inline-flex">임시 테스트</span>
      </div>

      <div className="grid gap-8 lg:grid-cols-2">
        <motion.section initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: .65, ease: [0.16, 1, 0.3, 1] }} className="overflow-hidden rounded-[26px] border border-[#211e19]/10 bg-white/45 p-4 sm:p-5">
        ...
        <motion.section initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: .65, delay: .1, ease: [0.16, 1, 0.3, 1] }} className="overflow-hidden rounded-[26px] border border-[#211e19]/10 bg-[#f7f4ee]/70 p-4 sm:p-5">
