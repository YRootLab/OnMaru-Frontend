  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <h3 className={`mt-0.5 line-clamp-2 font-sorimaru-sans text-[15px] font-bold leading-snug tracking-[-0.028em] sm:text-base ${isCurrent ? 'text-[#f84e76]' : 'text-[#211e19]'}`}>{story.title}</h3>
    ...
    <section className="rounded-2xl border border-[#211e19]/[0.07] bg-[#fbfaf8] p-4">
      <header className="mb-3 flex items-center gap-3">
        ...
        <div className="min-w-0">
          <h3 className="truncate font-sorimaru-sans text-[15px] font-bold tracking-[-0.03em] text-[#211e19]">{group.label}</h3>
