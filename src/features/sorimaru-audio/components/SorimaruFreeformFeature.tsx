...
export const SorimaruFreeformFeature: React.FC<SorimaruFreeformFeatureProps> = ({ apiService }) => {
  ...
  return (
    <div className="sorimaru-free relative min-h-screen overflow-hidden bg-[#e9e9e3] text-[#171717] selection:bg-[#2454ff] selection:text-white">
      ...
      <div className="relative z-10 w-full">
        <header className="border-b-2 ">
          <div className="flex min-h-14 items-center justify-between gap-4 text-[10px] font-semibold uppercase tracking-[0.16em]">
            <Link href="/sorimaru" className="shrink-0 transition-colors hover:text-[#2454ff]">ONMARU / SORIMARU</Link>
            <span className="hidden sm:block">Field notes for a slower Korea</span>
            <Link href="/sorimaru" className="shrink-0   pb-0.5 normal-case tracking-normal transition-colors hover: hover:text-[#2454ff]">
              기존 버전 보기 ↗
            </Link>
          </div>
        </header>
        ...
        <main>
          <section className="relative grid gap-10 border-b-2  py-14 sm:py-20 lg:grid-cols-[minmax(0,1.12fr)_minmax(300px,0.88fr)] lg:gap-16 lg:py-24">
            <div className="relative z-10">
              ...
              <h1 className="max-w-4xl font-sorimaru-sans text-[clamp(3.5rem,9vw,8.8rem)] font-black leading-[0.83] tracking-[-0.09em]">
                한국의<br />
              ...
              >
                ...
                <div className="absolute inset-3 flex flex-col justify-between bg-gradient-to-b from-[#171717]/45 via-transparent to-[#171717]/70 p-4 text-white sm:inset-4 sm:p-6">
                  ...
                  <div>
                    ...
                    <p className="mt-2 max-w-xs font-sorimaru-sans text-2xl font-bold leading-tight tracking-[-0.045em] sm:text-3xl">{activeStory.title}</p>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="min-w-0 py-10 lg:pl-10">
              <div className="flex items-end justify-between gap-6">
                <div>
                  ...
                  <h2 className="mt-2 font-sorimaru-sans text-3xl font-bold tracking-[-0.065em] sm:text-5xl">{activeTopicMeta.note}</h2>
                </div>
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between">
                      <div>
                        ...
                        <h3 className="mt-3 font-sorimaru-sans text-3xl font-bold leading-[0.98] tracking-[-0.065em] sm:text-5xl">{activeStory.title}</h3>
                    ...
                    {topicStories.slice(0, 4).map((story, index) => (
                      <button key={story.stid} type="button" onClick={() => setActiveIndex(index)} className={`group flex w-full gap-3 py-4 text-left ${story.stid === activeStory.stid ? 'text-[#2454ff]' : 'text-[#171717]'}`}>
                        ...
                        <span className="min-w-0 flex-1">
                          ...
                          <span className="mt-1 block truncate font-sorimaru-sans text-sm font-bold group-hover:text-[#2454ff]">{story.title}</span>
                        </span>
          ...
          <section className="relative border-b-2  bg-[#2454ff] py-12 text-white sm:py-16">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] lg:items-end">
              <div>
                ...
                <h2 className="mt-3 max-w-md font-sorimaru-sans text-4xl font-bold leading-[0.9] tracking-[-0.07em] sm:text-6xl">오늘,<br />여기에서</h2>
                  ...
                  return (
                    <button key={story.stid} type="button" onClick={() => { setNearbyIndex(index); playStory(story); }} className={`group grid grid-cols-[72px_minmax(0,1fr)] gap-3  p-2 text-left transition-transform hover:-translate-y-1 ${story.stid === nearbyStory.stid ? 'bg-[#d5f05a] text-[#171717]' : 'bg-white/10'}`}>
                      ...
                      <span className="min-w-0 self-center">
                        ...
                        <span className="mt-1 block truncate font-sorimaru-sans text-sm font-bold">{story.title}</span>
          ...
          <section className="py-14 sm:py-20" id="archive">
            <div className="flex flex-col justify-between gap-5 border-b-2  pb-6 sm:flex-row sm:items-end">
              <div>
                ...
                <h2 className="mt-2 font-sorimaru-sans text-4xl font-bold tracking-[-0.07em] sm:text-6xl">계속 걷기</h2>
              </div>
                  ...
                  <article key={story.stid} className={`group ${index === 1 ? 'lg:mt-16' : ''} ${index === 4 ? 'lg:-mt-10' : ''}`}>
                    ...
                    <div className="mt-3 flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <h3 className="mt-1 font-sorimaru-sans text-xl font-bold leading-tight tracking-[-0.045em] group-hover:text-[#2454ff]">{story.title}</h3>
          ...
          <footer className="flex flex-col justify-between gap-6 border-t-2  py-8 text-xs sm:flex-row sm:items-center">
            <p className="font-sorimaru-sans text-lg font-bold tracking-[-0.04em]">천천히 들어도, 여행입니다.</p>
