    ...
    <section aria-label="장면별 이야길 깊이 들여다보기" className="relative w-full py-8 sm:py-12">
      <div className="w-full">
        ...
        <div className="flex flex-col gap-1 pb-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="inline-block bg-gradient-to-r from-[#211e19] via-[#403b35] to-[#6a6158] bg-clip-text font-sorimaru-sans text-[clamp(24px,3.2vw,36px)] font-bold leading-tight tracking-[-0.04em] text-transparent">
              소리와 장면으로 만나는 한국의 온기
            </h2>
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col justify-between p-6 sm:p-8">
                <div>
                  <h3 className="font-sorimaru-sans text-2xl font-bold tracking-tight text-[#211e19] sm:text-3xl">
                    {activeChapter.title}
                  </h3>
