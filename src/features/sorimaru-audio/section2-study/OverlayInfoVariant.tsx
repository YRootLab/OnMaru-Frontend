      ...
      <StudyRail className="gap-4 sm:gap-5">
        {stories.map((story) => (
          ...
          >
            ...
            <span className="absolute left-4 top-4 rounded-full  bg-black/20 px-2.5 py-1 text-[10px] font-semibold text-white  backdrop-blur-md">
              {story.category}
            </span>
            <div className="absolute inset-x-3 bottom-3 rounded-[17px]  bg-[#fffdf9]/90 p-4  backdrop-blur-xl sm:inset-x-4 sm:bottom-4">
              <p className="truncate text-[10px] text-[#786d5e]">{story.location}</p>
