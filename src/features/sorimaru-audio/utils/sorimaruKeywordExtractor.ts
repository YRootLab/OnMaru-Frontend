...
import { SorimaruAtmosphereId } from '@/features/sorimaru-audio/types/sorimaruChapter.types';
...
const KEYWORD_CANDIDATES: Record<Exclude<SorimaruAtmosphereId, 'archive'>, KeywordCandidate[]> = {
  hanok: [
 ...
 */
export function extractSorimaruStoryKeywords(
  story: SorimaruStoryItem,
  fallbackKeywords: string[],
  atmosphereId: Exclude<SorimaruAtmosphereId, 'archive'>,
  limit = 4,
): string[] {
