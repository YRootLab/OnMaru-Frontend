import { SorimaruAtmosphere, SorimaruChapterDefinition } from '@/features/sorimaru-audio/types/sorimaruChapter.types';

export interface SorimaruChapterExtendedDefinition extends SorimaruChapterDefinition {
  heroImageUrl: string;
  mood: string;
  subTitle: string;
}

export const ARCHIVE_ATMOSPHERE: SorimaruAtmosphere = {
  id: 'archive',
...
export const SORIMARU_CHAPTER_DEFINITIONS: SorimaruChapterExtendedDefinition[] = [
  {
    id: 'hanok',
    keyword: '한옥',
    title: '한옥의 바람',
