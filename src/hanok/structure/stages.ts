...
export const STAGES: HanokStageData[] = [
  {
    ...
    desc: '건물의 하중을 지반에 고르게 전달하고 **빗물과 지하수로부터 건물을 보호**하기 위해 터보다 한층 높게 쌓은 기초 단입니다. 삼국시대부터 한옥의 핵심 구성 요소로 쓰였으며, 흙이나 돌 등 다양한 재료를 층층이 쌓아 올려 완성합니다. 기단의 높낮이를 다르게 설정하여 건축물에 공간의 위계성과 장중한 위엄을 부여합니다.',
    detail: '',
    meshKeywords: ['Kidan'],
    cameraPos: [14, 1.2, 15],
  ...
  },
  {
    ...
    desc: '지열을 피하고 통풍을 원활하게 하기 위해 기단에서 높게 띄워진 마루와 땅바닥 사이의 **단차를 극복하는 디딤돌**입니다. 별도의 현관 없이 신발을 벗고 바로 마루로 올라가는 한옥의 고유한 출입 구조를 위해 고안되었습니다. 보행의 피로를 덜어주며 안과 밖을 잇는 실용적인 계단 역할을 수행합니다.',
    detail: '',
    meshKeywords: ['Step'],
    cameraPos: [5, 2.2, 5.5],
  ...
  },
  {
    ...
    desc: '초석은 기둥을 통해 내려오는 지붕의 무게를 지반에 분산시키는 돌 부재로, 남은 배열을 통해 소실된 건물의 본래 형태를 추정하는 핵심 단서가 됩니다. 기둥은 공간을 형성하는 수직 뼈대로, 원통형이나 배흘림 등 다양한 형태로 입면에 시각적 아름다움을 더합니다. 또한 **귀솟음과 안쏠림 기법을 적용하여 착시를 막고 구조적 안정성을 극대화**합니다.',
    detail: '',
    meshKeywords: ['Pillar'],
    cameraPos: [10, 0.8, 10],
  ...
  },
  {
    ...
    desc: '땅바닥에서 일정 높이를 띄워 기둥과 귀틀을 짜 맞춘 뒤 널판을 덮어 시공하는 쾌적한 휴식 및 통풍 공간입니다. 온돌이 취침을 위한 닫힌 공간이라면, 마루는 **덥고 습한 여름철을 나기 위한 열린 공간**으로 작용합니다. 대청마루, 툇마루 등 위치에 따라 방과 방, 집 안과 마당을 자연스럽게 이어주는 매개체 역할을 합니다.',
    detail: '',
  ...
  },
  {
    ...
    desc: '기둥과 보가 하중을 전적으로 지탱하는 전통 목조 구조에서 벽은 **무게를 견디는 대신 공간을 분리**하는 데 집중합니다. 흙반죽에 돌이나 나무를 섞거나 거푸집으로 다져 쌓는 방식으로 뛰어난 자연 내구성을 확보합니다. 필요에 따라 구조를 쉽게 트거나 닫을 수 있어 유연하고 자유로운 공간 배치가 가능합니다.',
    detail: '',
    meshKeywords: ['Wall'],
    cameraPos: [0, 3.8, 17],
    cameraTarget: [0, 3.2, 0],
  ...
  },
  {
    ...
    desc: '틀에 넣은 점토를 가마에서 구워낸 지붕 마감재로, 눈비의 침수를 막아 **목조건물의 부식을 완벽히 차단**합니다. 암키와와 수키와를 정교하게 엮어 빗물을 자연스럽게 흘려보내도록 설계되었습니다. 처마 끝의 막새와 용마루의 치미 등 다채로운 장식 기와를 더해 건축물의 웅장함과 의장적 가치를 끌어올립니다.',
    detail: '',
    meshKeywords: ['Roof'],
    cameraPos: [18, 9.0, 20],
