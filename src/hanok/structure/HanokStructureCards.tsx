...
const Card = styled.button<{ $tint: string; $edge: string }>`
  display: flex;
  ...
  &:hover {
    ...
    box-shadow: 0 12px 32px rgba(25, 31, 40, 0.09);
  }
    ...
    <>
      <Grid>
        <Card
          ...
          $tint={lightPalette.hwanggeum[50]}
          $edge={lightPalette.hwanggeum[100]}
        >
        ...
        <Card
          ...
          $tint={lightPalette.juhong[50]}
          $edge={lightPalette.juhong[100]}
        >
